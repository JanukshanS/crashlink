  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <View style={styles.actions}>
        <Button mode="contained" onPress={() => router.push('/(auth)/login')} contentStyle={styles.tall}>
          {t('auth.login')}
        </Button>

        <Button mode="outlined" onPress={() => router.push('/(auth)/register')} contentStyle={styles.tall}>
          {t('auth.register')}
        </Button>
